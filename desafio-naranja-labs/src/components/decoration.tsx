  ...
  return (
    <div className="relative">
        <div className="absolute top-[-187px] left-[629px] w-[1492px] h-[1492px] z-[-2]">
          ...
          <Image src={girlDeco} priority className='w-[824px] h-[1234px] absolute top-[110px] left-[385px] z-[-4]' alt="Girl Decoration" />
          ...
          <Image src={circle1} className='w-[1080px] h-[1080px] absolute top-[206px] left-[206px] z-[-6]' alt="Circle 1 Decoration" />
          <Image src={circle2} className='w-[1492px] h-[1492px] absolute top-[0px] left-[0px] z-[-6]' alt="Circle 2 Decoration" />
        </div>
